        ...
        <section className='container-fluid my-2'>
            ...
            <div className="d-flex flex-column align-items-center text-center">
                ...
                <div className='container-sm px-3'>
                    <p className="text-light text-justify p-3">Imagina acordar todos os dias com sobrancelhas perfeitas, sem precisar gastar tempo a preenchê-las com maquilhagem. Com a micropigmentação de sobrancelhas, isso torna-se realidade! Este procedimento é ideal para quem quer sobrancelhas naturais, bem desenhadas e definidas sem esforço diário. Utilizamos técnicas avançadas para criar fios ultra-realistas ou um efeito sombreado suave, adaptado ao teu rosto e estilo. O resultado? Um olhar expressivo, jovem e harmonioso!</p>
                    
                    <div className="container">
                        <div className="row d-flex flex-column flex-md-row align-items-center">
                            <div className="col-md-4 text-center mb-3 mb-md-0">
                                <h2 className="text-light text-center fw-bold">Vantagens da micropigmentação ?</h2>
                            </div>
                            <div className="col-md-8">
                                <div className='container-sm px-3'>
                                    <ul className="text-light list-unstyled fw-bold">
            ...
            <div className="d-flex flex-column align-items-center text-center pt-1 mt-4 my-4 ">
                ...
                <Remocao />
                <div className='container-sm px-3'>                
                    <h3 className="text-light text-center fw-bold pt-3">Diga Adeus ao Que Já Não Combina Consigo!</h3>
                ...
                <div className="container">
                    <div className="row d-flex flex-column flex-md-row align-items-center">
                        ...
                        {/* Imagem - ocupa 4 colunas no desktop */}
                        <div className="col-md-4 text-center mb-3 mb-md-0">
                            <img
                                src={maquina}
                                alt="foto de keli"
                                loading="lazy"
                                className="rounded-circle border-end border-5"
                                style={{ width: '100%', height: 'auto', maxWidth: '250px' }}
                            />
                        </div>
                        {/* Texto - ocupa o restante no desktop */}
                        <div className="col-md-8">
                        <p className="text-light text-center text-md-start p-3">
                            Se procura a solução mais avançada e segura para remover tatuagens e micropigmentação, a máquina <span className="fw-bold">Omer Smart</span> é a escolha perfeita! Com tecnologia de ponta e certificação com selo da <span className="fw-bold">ANVISA</span>, garante um tratamento seguro, eficaz e aprovado pelos mais altos padrões de qualidade. O laser de alta precisão quebra os pigmentos sem agredir a pele, proporcionando um processo confortável e com menos sessões do que os métodos tradicionais. Ideal para todos os tipos de pele e cores de tinta, a Omer Smart oferece resultados visíveis desde a primeira sessão, sem riscos de cicatrizes ou danos. Se deseja uma remoção segura e definitiva, esta é a melhor opção para recuperar a sua pele com confiança!
                        </p>
                        </div>
                    </div>
                </div>
