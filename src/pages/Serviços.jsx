...
const Serviços = () => {
    ...
    return (
        <section className='container-fluid my-3'>
            ...
            {/* remoção */}
            <div className="d-flex flex-column align-items-center text-center pt-1 mt-4 my-4 bg-light">
                ...
                <Remocao />
                <p className="text-dark text-center p-3">Cada sessão é rápida e personalizada para garantir o melhor resultado possível. Dependendo da profundidade e da cor do pigmento, pode precisar de mais de uma sessão, mas já verá melhorias desde a primeira!</p>
            </div>
