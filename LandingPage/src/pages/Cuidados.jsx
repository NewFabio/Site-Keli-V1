...
const Cuidados = () => {
    return (
        <article className="container-fluid mt-4 d-flex flex-column justify-content-center align-items-center">            
            ...
            <div className="embed-responsive embed-responsive-14by9">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ROwSBhG2INs?si=ZLESqv1FK23RtM5Z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </article>
    );
}
